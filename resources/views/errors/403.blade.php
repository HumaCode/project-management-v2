...
<head>
    ...
    <title>403 Forbidden &mdash; Project Management System</title>
    ...
    <style>
        ...
        *::after {
        ...
        .grid-bg {
            ...
            pointer-events: none;
            background-image:
                linear-gradient(rgba(255, 77, 109, 0.04) 1px,
                    transparent 1px),
                linear-gradient(90deg,
                    rgba(255, 77, 109, 0.04) 1px,
                    transparent 1px);
        ...
        #mainIcon {
            animation:
                lockshake 3s ease-in-out infinite,
                iconbounce 0s;
        }
...
<body>
    ...
    <div class="page-wrap">
        <div class="card-wrap">
            <!-- Error code -->
            <div class="err-code" data-text="403">403</div>
            <div class="err-type">Forbidden</div>
            ...
            <div class="icon-zone">
                ...
                <i class="bi bi-shield-fill-x icon-main" id="mainIcon"></i>
            ...
            <p class="err-desc">
                ...
                sumber daya ini. Silakan hubungi administrator sistem.
            </p>

            <!-- Info box -->
            <div class="info-box">
                <div class="ib-row">
                    <span class="ib-lbl">Kode Error</span><span>403 Forbidden</span>
                </div>
                <div class="ib-row">
                    <span class="ib-lbl">Penyebab</span><span>Hak akses tidak mencukupi atau sesi tidak
                        valid</span>
                </div>
                <div class="ib-row">
                    <span class="ib-lbl">Solusi</span><span>Hubungi admin untuk mendapatkan izin akses</span>
                </div>
            </div>
            ...
            <div class="status-bar">
                ...
                <span>HTTP 403 &nbsp;&bull;&nbsp; pmssystem.id
