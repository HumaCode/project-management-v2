...
<html lang="id">
    <head>
        ...
        <title>404 Not Found &mdash; Project Management System</title>
        <link
        ...
        <style>
            ...
            *::after {
            ...
            @keyframes codepulse {
                ...
                50% {
                    filter: drop-shadow(0 0 40px var(--clr))
                        drop-shadow(
                            0 0 100px
                                color-mix(in srgb, var(--clr) 60%, transparent)
                        );
                }
            }
            ...
            .icon-ring2 {
                ...
                border-radius: 50%;
                border: 1px dashed
                    color-mix(in srgb, var(--clr) 25%, transparent);
            ...
            @keyframes iconbounce {
                ...
                50% {
                    ...
                    filter: drop-shadow(0 0 28px var(--clr))
                        drop-shadow(
                            0 0 50px
                                color-mix(in srgb, var(--clr) 50%, transparent)
                        );
                }
            }
            ...
            #mainIcon {
                ...
                filter: drop-shadow(0 0 16px #00c8ff);
            }
    ...
    <body>
        ...
        <div class="page-wrap">
            <div class="card-wrap">
                <!-- Error code -->
                <div class="err-code" data-text="404">404</div>
                <div class="err-type">Not Found</div>
                ...
                <div class="icon-zone">
                    ...
                    <i class="bi bi-compass icon-main" id="mainIcon"></i>
                    <i
                ...
                <p class="err-desc">
                    Halaman yang Anda cari tidak ditemukan. Mungkin URL salah
                    ketik, halaman telah dihapus, atau dipindahkan ke lokasi
                    lain.
                </p>
                ...
                <div class="info-box">
                    ...
                    <div class="ib-row">
                        ...
                        ><span
                            >URL salah, halaman dihapus, atau dipindahkan</span
                        >
                    </div>
                    <div class="ib-row">
                        <span class="ib-lbl">Solusi</span
                        ><span
                            >Periksa kembali URL atau gunakan navigasi
                            sidebar</span
                        >
                    </div>
                </div>
