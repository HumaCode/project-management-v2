...
<head>
    ...
    <title>
        500 Internal Server Error &mdash; Project Management System
    </title>
    ...
    <style>
        ...
        *::after {
        ...
        @keyframes serverrumble {
            ...
            /* spark flash */
            50% {
                filter: drop-shadow(0 0 24px #f59e0b) drop-shadow(0 0 8px #fff) brightness(1.3);
            }
        ...
        #mainIcon {
            animation: serverrumble 3s ease-in-out infinite;
        }
        ...
        @keyframes sparkanim {
            ...
            30% {
                opacity: 1;
                transform: scaleY(1) translateY(-8px) rotate(var(--r, 0deg));
            }

            60% {
                opacity: 0.5;
                transform: scaleY(0.5) translateY(-14px) rotate(calc(var(--r, 0deg) + 15deg));
            }
        }
...
<body>
    ...
    <div class="page-wrap">
        <div class="card-wrap">
            <!-- Error code -->
            <div class="err-code" data-text="500">500</div>
            <div class="err-type">Internal Server Error</div>
            ...
            <div class="icon-zone">
                ...
                <i class="bi bi-server icon-main" id="mainIcon"></i>
                <div class="spark"></div>
                <div class="spark"></div>
                <div class="spark"></div>
            </div>
            ...
            <!-- Title & description -->
            <h1 class="err-title">Kesalahan Internal Server</h1>
            <div class="neon-div"></div>
            <p class="err-desc">
                Terjadi kesalahan tidak terduga pada server. Tim teknis kami
                telah diberitahu dan sedang menangani masalah ini.
            </p>

            <!-- Info box -->
            <div class="info-box">
                <div class="ib-row">
                    <span class="ib-lbl">Kode Error</span><span>500 Internal Server Error</span>
                </div>
                <div class="ib-row">
                    <span class="ib-lbl">Penyebab</span><span>Kesalahan tak terduga pada konfigurasi server</span>
                </div>
                <div class="ib-row">
                    <span class="ib-lbl">Solusi</span><span>Tunggu beberapa saat, tim sedang memperbaiki
                        masalah ini</span>
                </div>
            </div>
            ...
            <div class="status-bar">
                ...
                <span>HTTP 500 &nbsp;&bull;&nbsp; pmssystem.id
