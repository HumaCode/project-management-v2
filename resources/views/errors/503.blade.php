...
<html lang="id">
    <head>
        ...
        <title>503 Service Unavailable &mdash; Project Management System</title>
        <link
        ...
        <style>
            ...
            --bg:#050e1d;
              --clr:#00e5a0;
              --clr-rgb:0,229,160;
              --cyan:#00c8ff;--blue:#0072c6;
              --txt:#e2eaf4;--dim:#7a90a8;--muted:#3d5068;
              --bd:rgba(0,229,160,.15);
              --card:rgba(7,21,40,.85);
            ...
            *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
            ...
            /* ══ Corner decorations ══ */
            .corner{
              position:fixed;width:60px;height:60px;z-index:2;pointer-events:none;
              opacity:.4;
            }
            ...
            .corner-tr{animation-delay:.75s}
            .corner-bl{animation-delay:1.5s}
            .corner-br{animation-delay:2.25s}
            @keyframes cornerpulse{
              0%,100%{opacity:.25}
              50%{opacity:.65;filter:drop-shadow(0 0 8px var(--clr))}
            }
            ...
            @keyframes codepulse{
              0%,100%{filter:drop-shadow(0 0 20px var(--clr)) drop-shadow(0 0 60px color-mix(in srgb,var(--clr) 40%,transparent))}
              50%{filter:drop-shadow(0 0 40px var(--clr)) drop-shadow(0 0 100px color-mix(in srgb,var(--clr) 60%,transparent))}
            }
            ...
            @keyframes glitch2{
              ...
              93%{opacity:.7;transform:translate(3px,2px)}
            ...
            @keyframes dotorbit{
              0%{transform:translate(-4px,-4px) rotate(0deg) translateX(45px)}
              100%{transform:translate(-4px,-4px) rotate(360deg) translateX(45px)}
            }
            .icon-main{
            ...
            @keyframes iconbounce{
              0%,100%{transform:translateY(0) scale(1);filter:drop-shadow(0 0 16px var(--clr))}
              50%{transform:translateY(-8px) scale(1.05);filter:drop-shadow(0 0 28px var(--clr)) drop-shadow(0 0 50px color-mix(in srgb,var(--clr) 50%,transparent))}
            }
            ...
            @keyframes wrenchswing{
              ...
              50%{transform:translateY(-9px) rotate(20deg) scale(1.08)}
              75%{transform:translateY(-6px) rotate(5deg) scale(1.05)}
            }
            #mainIcon{ animation:wrenchswing 2s ease-in-out infinite; transform-origin:center; }
            .maint-badge{
            ...
            .gear{{
              position:absolute;
              font-size:20px;color:#00e5a0;opacity:.7;
              filter:drop-shadow(0 0 6px #00e5a0);
            }}
            .gear-1{{bottom:10px;left:10px;animation:spinring 3s linear infinite}}
            .gear-2{{bottom:14px;right:6px;font-size:14px;animation:spinring 2s linear infinite reverse}}


            /* ══ Text ══ */
            .err-type{
              font-family:var(--mono);font-size:11px;letter-spacing:3px;
              text-transform:uppercase;color:var(--clr);margin-bottom:10px;
              opacity:.85;
            }
            .err-title{
            ...
            .info-box .ib-lbl{color:var(--clr);font-weight:600;min-width:80px;flex-shrink:0}

            /* ══ Buttons ══ */
            .btn-row{display:flex;gap:10px;justify-content:center;flex-wrap:wrap}
            .btn-primary{
              display:inline-flex;align-items:center;gap:8px;
              padding:0 24px;height:46px;border-radius:var(--rs);
              background:linear-gradient(135deg,color-mix(in srgb,var(--clr) 70%,#000),var(--clr));
              border:none;color:#fff;font-family:var(--font);font-size:14px;font-weight:700;
            ...
            .btn-secondary:hover{
              ...
              color:var(--clr);border-color:rgba(0,229,160,.5);
              transform:translateY(-2px);
            }
            ...
            .debris{
              ...
              opacity:0;animation:dbdrift linear infinite;
            }
            @keyframes dbdrift{
            ...
            @media(max-width:767.98px){
              ...
              .err-code{font-size:clamp(64px,18vw,100px);letter-spacing:-2px}
              .icon-zone{width:110px;height:110px}
              .icon-main{font-size:42px}
              .icon-ring3{inset:-28px}
              .err-title{font-size:clamp(18px,5vw,24px)}
              .err-desc{font-size:14px}
              .btn-primary,.btn-secondary{height:42px;padding:0 18px;font-size:13px}
              .corner{width:40px;height:40px;top:12px}
              .corner-tl,.corner-tr{top:12px}.corner-tr{right:12px}.corner-tl{left:12px}
              .corner-bl,.corner-br{bottom:12px}.corner-br{right:12px}.corner-bl{left:12px}
            }
            @media(max-width:575.98px){
              .page-wrap{padding:24px 14px}
              .btn-row{flex-direction:column;align-items:center}
              .btn-primary,.btn-secondary{width:100%;max-width:300px;justify-content:center}
              .info-box .ib-row{flex-direction:column;gap:2px}
              .info-box .ib-lbl{min-width:auto}
            }
            @media(min-width:1200px){
              .card-wrap{max-width:680px}
            }
            @media(min-width:1600px){
              .page-wrap{padding:60px 20px}
            }
        </style>
    </head>
    <body>
        ...
        <div class="page-wrap">
            <div class="card-wrap">
                <!-- Error code -->
                <div class="err-code" data-text="503">503</div>
                <div class="err-type">Service Unavailable</div>
                ...
                <div class="icon-zone">
                    ...
                    <i class="bi bi-tools icon-main" id="mainIcon"></i>
                ...
                <!-- Title & description -->
                <h1 class="err-title">Layanan Tidak Tersedia</h1>
                <div class="neon-div"></div>
                <p class="err-desc">
                    Server sedang menjalani pemeliharaan terjadwal atau
                    mengalami beban berlebih. Layanan akan segera kembali
                    normal.
                </p>
                ...
                <div class="info-box">
                    <div class="ib-row">
                        <span class="ib-lbl">Kode Error</span
                        ><span>503 Service Unavailable</span>
                    </div>
                    <div class="ib-row">
                        <span class="ib-lbl">Penyebab</span
                        ><span
                            >Server sedang overload atau dalam mode
                            maintenance</span
                        >
                    </div>
                    <div class="ib-row">
                        <span class="ib-lbl">Estimasi</span
                        ><span>Layanan akan kembali dalam ± 30 menit</span>
                    </div>
                </div>
                ...
                <div class="status-bar">
                    ...
                    <span
                        >HTTP 503 &nbsp;&bull;&nbsp; pmssystem.id
                        &nbsp;&bull;&nbsp; <span id="errTime"></span
                    ></span>
                </div>
            </div>
        </div>
