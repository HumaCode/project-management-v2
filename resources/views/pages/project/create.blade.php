<x-master-layout>
    ...
    <div class="crd mb-24" data-aos="fade-up">
        <div class="crd-head">
            <div class="crd-title"><i class="bi bi-pencil-square"></i> Form Project Baru</div>
            <span class="crd-badge"><i class="bi bi-asterisk" style="font-size:8px;margin-right:2px"></i>Wajib diisi</span>
        </div>

        <div class="form-body">
            <form id="formCreateProject" action="{{ route('projects.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-12">
                        <div class="fg">
                            ...
                            <textarea name="description" class="fa" id="fDesc"
                                placeholder="Jelaskan tujuan, ruang lingkup, dan target project ini..." maxlength="500" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="fg">
                            <label>Status Awal <span class="req">*</span></label>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="tip">
                            ...
                            <p>Pastikan deadline realistis. Project dengan deadline yang sudah lewat akan muncul sebagai
                                <strong style="color:var(--err)">Terlambat</strong> di dashboard secara otomatis.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="fg">
                            ...
                            <div class="sl-wrap">
                                <div class="sl-val" id="slVal" style="left:0%">0%</div>
                    ...
                    <div class="col-12">
                        <div class="fg">
                            ...
                            <textarea name="notes" class="fa" id="fNotes"
                                placeholder="Catatan khusus atau info tambahan untuk tim..." maxlength="300" rows="3"></textarea>
                ...
                <div class="factions mt-4">
                    ...
                    <button type="button" class="btn-save" id="btnSave">
                        <span><i class="bi bi-check2-circle"></i> Simpan Project</span>
                    </button>
                </div>
            </form>
        </div>
    ...
    @push('js')
        ...
        <script src="{{ asset('assets/auth/backend/js/project-create.js') }}"></script>
    @endpush
</x-master-layout>
